...
Note: This code was completed with the aid of LLMs. 
All final decisions on implementation and core ideas are my own. 
LLMs were primarily used to bug fix, increase effiencincy (especially for cleaning and reading the data due to large file sizes), 
push code faster, and point me in the direction of various methods which I then researched prior to coding with the help of an LLM.
